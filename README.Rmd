...
```{r img20, echo=FALSE, fig.cap=c("Image 20, original and colored"),out.width="49%", out.height="20%",fig.show='hold',fig.align='center'}
knitr::include_graphics(c(path.expand("~/assignment/Other/img20.png"),path.expand("~/assignment/Other/img20_col.png"))) 
```
